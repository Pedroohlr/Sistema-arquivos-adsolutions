...
@section('content')
                                ...
                                <tr class="hover:bg-[#171717] transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="h-9 w-9 bg-[#f2c700] rounded-full flex items-center justify-center flex-shrink-0">
                                        ...
                                        @if($cliente->subpastas->count() > 0)
                                            <div class="flex flex-wrap gap-1">
                                                @foreach($cliente->subpastas as $subpasta)
                                                    <span
                                                        class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs bg-gray-800 text-gray-300">
    ...
    <div id="editUsuarioModal" class="hidden fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4"
        ...
        <div class="bg-[#1e1e1e] rounded-lg p-6 w-full max-w-md border border-gray-800" onclick="event.stopPropagation()">
            ...
            <form id="editUsuarioForm" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-white mb-1">Nova Senha <span
