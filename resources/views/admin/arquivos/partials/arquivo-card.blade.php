<div
    class="group transform rounded-lg border border-gray-800 bg-bg-primary p-4 transition-all duration-300 hover:scale-[1.02] hover:border-primary hover:shadow-lg hover:shadow-primary/10">
        ...
        <div class="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div class="shrink-0 transform transition-transform duration-300 group-hover:scale-110">
                @php
                    ...
                    elseif (in_array($extension, ['exe', 'msi']))
                ...
                @endphp
                <svg class="w-10 h-10 {{ $iconColor }} group-hover:drop-shadow-lg transition-all" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
            ...
            <div class="min-w-0 flex-1">
                <h4 class="truncate text-sm font-medium text-white transition-colors group-hover:text-primary">
                    {{ $arquivo->nome }}</h4>
