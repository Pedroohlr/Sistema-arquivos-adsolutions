...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#f2c700]/20 to-[#f2c700]/10 rounded-lg border border-[#f2c700]/30 p-6">
        ...
        <p class="text-gray-300">Bem-vindo ao seu portal de arquivos. Aqui você pode acessar e baixar todos os arquivos disponíveis para você.</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-[#171717] rounded-lg p-4 border border-gray-800">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs text-gray-400">Minha Pasta</p>
                            <p class="text-lg font-semibold text-white">{{ $cliente->arquivos->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-[#171717] rounded-lg p-4 border border-gray-800">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs text-gray-400">Total Disponível</p>
                            <p class="text-lg font-semibold text-white">{{ $grupo->arquivos->count() + $cliente->arquivos->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @else
        <div class="text-center py-16 bg-[#1e1e1e] rounded-lg border border-gray-800">
            ...
            <p class="mt-2 text-sm text-gray-400 max-w-md mx-auto">Você ainda não tem acesso a nenhum grupo de arquivos. Entre em contato com o administrador para obter acesso.</p>
        </div>
    @endif
    ...
    <div class="bg-[#1e1e1e] rounded-lg border border-gray-800 p-6">
        ...
        <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-start gap-3">
                <svg class="w-5 h-5 text-[#f2c700] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
