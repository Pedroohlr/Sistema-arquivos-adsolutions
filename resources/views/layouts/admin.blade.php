...
<body class="h-full overflow-x-hidden bg-[#171717] text-white font-sans antialiased">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:z-50">
            <div class="flex flex-col flex-grow bg-[#1e1e1e] border-r border-gray-800">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    <a href="{{ route('admin.arquivos.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300
    ...
    : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.usuarios.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300
    ...
    : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.admins.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300
    ...
    : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.historico.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300
        ...
        <div class="ml-auto h-full w-full max-w-xs bg-[#1e1e1e] shadow-xl" onclick="event.stopPropagation()">
            ...
            <nav class="flex h-[calc(100%-81px)] flex-col p-4">
                <div class="space-y-2">
                    ...
                    <a href="{{ route('admin.usuarios.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-colors
                    ...
                    <a href="{{ route('admin.admins.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-colors
                          {{ request()->routeIs('admin.admins.*') ? 'bg-gray-700 text-white' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.historico.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-colors
