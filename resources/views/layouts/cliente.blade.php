            ...
            <div class="flex flex-col flex-grow bg-[#1e1e1e] border-r border-gray-800">
                ...
                <div class="px-4 py-4 border-t border-gray-800">
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-sm text-gray-300 truncate">Olá, {{ auth()->guard('cliente')->user()->usuario }}</span>
                    </div>
            ...
            <div class="px-4 sm:px-6">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm text-gray-300 hidden sm:block">Olá, {{ auth()->guard('cliente')->user()->usuario }}</span>
                        <form method="POST" action="{{ route('cliente.logout') }}">
                            @csrf
                            <button type="submit" 
